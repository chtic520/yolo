  ...
  $.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      if ($("body").hasClass("fixed")) {
        ...
        $("#content").css('min-height', window_height - footer_height - 50);
      } else {
        var postSetWidth;
        ...
        if (typeof controlSidebar !== "undefined") {
          if (controlSidebar.height() > postSetWidth)
            $(".content-wrapper, .right-side"/*, #content"*/).css('height', controlSidebar.height());
            $("#content").css('min-height', controlSidebar.height());
        }
