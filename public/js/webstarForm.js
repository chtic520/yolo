$(document).ready(function(){
	...
	$("#t").on('click', function(){
		...
		$("#tagList").find('.tag:checked').each(function(){
			...
			html += '<span class="label label-info">'+tagName+'<input type="hidden" name="webstar[category]" value="'+tagId+'"></span>&nbsp;'
		})
	...
	$("#p").on('click', function(){
		...
		$("#platformList").find('.tag:checked').each(function(){
			var tagName = $(this).siblings('span').html();
			var tagId = $(this).attr('id');
			html += '<span class="label label-info">'+tagName+'<input type="hidden" name="webstar[platform]" value="'+tagId+'"></span>&nbsp;'
		})
